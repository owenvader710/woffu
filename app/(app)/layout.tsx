    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      >
        <button
          ...
          className={`absolute inset-0 bg-black/72 backdrop-blur-[2px] transition-opacity duration-300 ${
        ...
        <div
          className={`absolute left-0 top-0 h-full w-[84%] max-w-[340px] border-r border-white/10 bg-[#0b0b0b] shadow-[0_0_80px_rgba(0,0,0,0.55)] transition-transform duration-300 ease-out ${
